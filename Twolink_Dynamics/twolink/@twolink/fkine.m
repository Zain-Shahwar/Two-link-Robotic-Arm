...
%% FKINE - Forward kinematics solution including tool transformation for the two link arm. 
% ========================================================================= 
%    
%    T = fkine(rob,q) 
%    T = rob.fkine(q) 
...
t3 = cos(t2);
t4 = sin(t2);
t5 = t4.*9.996242168594817e-1;
t6 = t4.*2.741213359204429e-2;
t7 = sin(q1);
fkine = reshape([t3,t5,t6,0.0,-t4,t3.*9.996242168594817e-1,t3.*2.741213359204429e-2,0.0,0.0,-2.741213359204429e-2,9.996242168594817e-1,0.0,t3+cos(q1),t5+t7.*9.996242168594817e-1,t6+t7.*2.741213359204429e-2,1.0],[4,4]);
