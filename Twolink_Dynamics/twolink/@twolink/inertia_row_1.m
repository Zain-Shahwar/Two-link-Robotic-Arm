...
%% INERTIA_ROW_1 - Computation of the robot specific inertia matrix row for corresponding to joint 1 of 2. 
% ========================================================================= 
%    
...
%    inertia matrix row number 1 of 2 for two link. 
%    
%  Input:: 
...
%    12-Mar-2019 13:59:38

q2 = in2(:,2);
t2 = cos(q2);
Irow = [t2+3.0./2.0,t2.*(1.0./2.0)+1.0./4.0];
