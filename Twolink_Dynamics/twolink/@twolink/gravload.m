...
%% GRAVLOAD - Computation of the configuration dependent vector of gravitational load forces/torques for two link 
% ========================================================================= 
%    
%    G = gravload(rob,q) 
%    G = rob.gravload(q) 
...
%    
%  Output:: 
%    G:  [2x1] vector of gravitational load forces/torques 
%    
%  Example:: 
%    --- 
%    
...
%    12-Mar-2019 13:59:27

q1 = in2(:,1);
q2 = in2(:,2);
t2 = q1+q2;
t3 = cos(t2);
t4 = t3.*1.344565152689773e-1;
G = [t4+cos(q1).*4.033695458069318e-1,t4];
